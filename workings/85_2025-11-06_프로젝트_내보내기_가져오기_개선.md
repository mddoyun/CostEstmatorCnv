...
- `connections/views.py`:
  - `import_project()` 함수 (라인 4072, 4141-4151, 4155-4159)
...
프로젝트 내보내기/가져오기 기능이 **모든 최신 필드(visibility_filters 포함)를 완전히 저장하고 복원**하도록 개선되었습니다.

**완료된 항목**:
- ✅ visibility_filters 필드 저장
- ✅ visibility_filters 필드 복원 (기존 프로젝트)
- ✅ visibility_filters 필드 복원 (새 프로젝트)
- ✅ 확장 가능한 필드 업데이트 로직

**향후 추가 필드**가 생겨도 동일한 패턴으로 쉽게 확장할 수 있습니다.
